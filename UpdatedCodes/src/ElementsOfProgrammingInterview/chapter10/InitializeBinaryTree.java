...
public class InitializeBinaryTree {
    ...
    public static BinaryTreeNode<String> superSimple() {
        BinaryTreeNode<String> root = new BinaryTreeNode<>("B");
        root.left = new BinaryTreeNode<>("A");
        root.right = new BinaryTreeNode<>("C");
        root.left.left = new BinaryTreeNode<>("E");
        root.left.right = new BinaryTreeNode<>("G");
        root.right.right = new BinaryTreeNode<>("F");
        root.right.right.right = new BinaryTreeNode<>("J");
        root.right.right.right.left = new BinaryTreeNode<>("L");
        return root;
    }
